...
<section class="header" style=" background:url(images/19.png); background-repeat: no-repeat;   min-height: 60vh; background-position: center; background-size: cover">
                       <nav>
...
<p style="color:white"> Frequently asked Questions.
</p>
...
<img  src="images/LOGO.png"/>
    ...
    <p>HOW SERVICES WORK?<br />
When a customer places an order on the Lulama website, the system records the details of the order. <br />
        This includes the products selected, quantities, shipping address, and any special instructions. <br />
       The order information is then verified to ensure its accuracy. <br />
        Lulama’s system checks the inventory to determine product availability. <br />
       If the items are in stock, the order proceeds to the next step.<br /> 
       Otherwise, the system may notify the customer about any backorders or delays. <br />
       The warehouse staff picks the ordered items from the shelves based on the order details..</p><br />
...
<br />
          <br /><h2><span class="ab">LSS</span> Network</h2>
<p> Order Now!</p>
